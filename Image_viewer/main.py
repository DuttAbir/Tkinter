...
root.tk.call('wm', 'iconphoto', root._w, PhotoImage(file='Image_viewer/image.png'))

img1 = Image.open("Image_viewer/Images/panda.png")
img1_resize = img1.resize((360, 360))
my_img1 = ImageTk.PhotoImage(img1_resize)

img2 = Image.open("Image_viewer/Images/panda2.png")
img2_resize = img2.resize((360, 360))
my_img2 = ImageTk.PhotoImage(img2_resize)

img3 = Image.open("Image_viewer/Images/panda3.png")
img3_resize = img3.resize((360, 360))
my_img3 = ImageTk.PhotoImage(img3_resize)


img4 = Image.open("Image_viewer/Images/po.png")
img4_resize = img4.resize((360, 360))
my_img4 = ImageTk.PhotoImage(img4_resize)

img5 = Image.open("Image_viewer/Images/pandasssss.png")
...
def next(image_num):
  ...
  status.grid(row=2, column=0, columnspan=3, sticky=W+E, padx= 10)
